...
# tbl_cross() creates nead cross-tabulations with row/column percentages
mortality |> 
...
9. Perform a likelihood ratio test of the H0 that, after accounting for onchocercal infection and visual impairment, there is no association between visual impairment and odds of death. Confirm you understand why a Wald test cannot be used here.

```{r}
# Create a simpler regression without age
model_noage <- glm(died ~ vimp + mfpos,
                        data = mortality,
                        family = binomial())

# LRT
lrtest(model_adj, model_noage)
```
