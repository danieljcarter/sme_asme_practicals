...
5. Calculate stratum-specific ORs for the interaction model.

We can use marginaleffects or emmeans to calculate stratum-specific odds ratios. Both approaches give identical results.

**Approach 1: Using marginaleffects**
...
# Get stratum-specific ORs for vimp in each sex group
avg_comparisons(model_int_age,
                variables = "vimp",
                by = "sex",
                comparison = "lnor",  # Log odds ratio 
                transform = "exp")

```

**Approach 2: Using emmeans** -- matches lincom() exactly
...
Use marginaleffects or emmeans to calculate age-specific ORs for the association between education and HIV.

**Approach 1: Using marginaleffects**

```{r}
# Get education ORs for each age group
avg_comparisons(mod_int,
                variables = "ed2",
                by = "age3",
                comparison = "lnor",  # Log odds ratio 
                transform = "exp")        # Exponentiate to OR
```

**Approach 2: Using emmeans** 
